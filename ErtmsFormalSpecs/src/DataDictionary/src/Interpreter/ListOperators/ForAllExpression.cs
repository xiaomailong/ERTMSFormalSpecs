...
namespace DataDictionary.Interpreter.ListOperators
{
    public class ForAllExpression : ConditionBasedListExpression
    {
        ...
        public ForAllExpression(ModelElement root, ModelElement log, Expression listExpression, string iteratorVariableName, Expression condition, int start, int end)
