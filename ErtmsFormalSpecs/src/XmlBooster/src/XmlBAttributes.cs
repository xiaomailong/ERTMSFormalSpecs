...
namespace XmlBooster
{
    ...
    {
        public XmlBSystemAttribute(string Name, Type acceptor) { this.Name = Name; this.acceptor = acceptor; }
    ...
    {
        public XmlBIndexFieldAttribute(string SystemName, string FieldName) { this.SystemName = SystemName; this.FieldName = FieldName; }
    ...
    {
        public XmlBElementAttribute(Type System, string Name) { this.System = System; this.Name = Name; }
        public string Name { get; set; }
    ...
    {
        public XmlBFieldAllowedTypeAttribute(Type Type) { this.Type = Type; }
    ...
    {
        public XmlBEnumAttribute(Type System, string Name) { this.System = System; this.Name = Name; }
        public Type System { get; set; }
        public string Name { get; set; }
    }
    ...
    {
        public XmlBEnumValueAttribute(string Name) { this.Name = Name; }
        public string Name { get; set; }
    }
    [AttributeUsage(AttributeTargets.Property)]
    public class XmlBGroupAttribute : Attribute
    {
        public XmlBGroupAttribute(string Name) { this.Name = Name; }
        public string Name { get; set; }
    }
    [AttributeUsage(AttributeTargets.Class, AllowMultiple=true)]
    public class XmlBFieldGroupAttribute : Attribute
    {
        public XmlBFieldGroupAttribute(string Name, string shortDesc) { this.Name = Name; this.ShortDesc = shortDesc; }
        public string Name { get; set; }
        public string ShortDesc { get; set; }
    }
    ...
    {
        public XmlBBuilderAttribute(Type Element) { this.Element = Element; }
